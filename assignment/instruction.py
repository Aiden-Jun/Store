...
# ----------------------------------------------------------------------------------------------------
# 첫째, Database => Repository 데이터 변환 과정
...
# 6. 판매자의 홈 화면
# 구매자의 이메일과 판매중인 상품 목록 아이디와 이름 리스트, 계좌의 잔액을 표시하세요
...
# buyer 딕셔너리의 email과 product 딕셔너리의 product_id 데이터를 사용해서 서비스에 상품 구매 요청을 하세요
# ----------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------
# 셋째, Domain => Repository => Database 데이터 변환 과정
